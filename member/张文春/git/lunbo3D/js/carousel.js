...
VCarousel.prototype = {
    ...
    switchItem: function(index) {
        ...
        this.leftImgItem = $('.img-item[data-index=' + ((index+this.listSize - 2)%this.listSize) + ']');
        this.prevImgItem = $('.img-item[data-index=' + ((index+this.listSize - 1)%this.listSize) + ']');            
        this.nextImgItem = $('.img-item[data-index=' + ((index + 1)%this.listSize) + ']');
        this.rightImgItem = $('.img-item[data-index=' + ((index +2)%this.listSize) + ']');
        this.addStyle();
    }
}