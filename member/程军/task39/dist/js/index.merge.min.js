...
! function(e, t) {
	...
	function b(e) {
		var t = J,
			n = Re[e];
		return n || (n = x(e, t), "none" !== n && n || (We = (We || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = We[0].contentDocument, t.write(), t.close(), n = x(e, t), We.detach()), Re[e] = n), n
	}
	...
	function L(e, t, n) {
		...
		if (Z.isEmptyObject(p)) "inline" === ("none" === c ? b(e.nodeName) : c) && (d.display = c);
			...
			for (r in p) s = q(h ? g[r] : 0, r, f), r in g || (g[r] = s.start, h && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
		}
	}
	...
	function H(e, t, n) {
		var r, i, o = 0,
			...
			u = function() {
				if (i) return !1;
				for (var t = Qe || D(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, s = 0, u = c.tweens.length; u > s; s++) c.tweens[s].run(o);
	...
	var ie = function(e) {
			...
			if (H && !r) {
				...
				if (w.qsa && (!O || !O.test(e))) {
					if (d = f = W, h = t, g = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
						for (c = k(e), (f = t.getAttribute("id")) ? d = f.replace(be, "\\$&") : t.setAttribute("id", d), d = "[id='" + d + "'] ", u = c.length; u--;) c[u] = d + p(c[u]);
		...
		function v(e, t, n, i, o, s) {
			return i && !i[W] && (i = v(i)), o && !o[W] && (o = v(o, s)), r(function(r, s, a, u) {
				var c, l, f, p = [],
					...
					x = n ? o || (r ? e : h || i) ? [] : s : y;
				if (n && n(y, x, a, u), i)
					for (c = m(x, d), i(c, [], a, u), l = c.length; l--;)(f = c[l]) && (x[d[l]] = !(y[d[l]] = f));
				if (r) {
					if (o || e) {
						if (o) {
			...
			var i = n.length > 0,
				...
				s = function(r, s, a, u, c) {
					var l, f, p, d = 0,
						...
						w = x.length;
					for (c && (S = s !== L && s); h !== w && null != (l = x[h]); h++) {
						if (o && l) {
							for (f = 0; p = e[f++];)
								if (p(l, s, a)) {
									u.push(l);
		...
		var b, w, T, C, N, k, E, j, S, D, A, q, L, $, H, O, F, M, P, W = "sizzle" + -new Date,
			R = e.document,
			B = 0,
			I = 0,
			_ = n(),
		...
		w = t.support = {}, N = t.isXML = function(e) {
			...
			var t, n = e ? e.ownerDocument || e : R,
				r = n.defaultView;
			return n !== L && 9 === n.nodeType && n.documentElement ? (L = n, $ = n.documentElement, H = !N(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
				q()
				...
				return $.appendChild(e).id = W, !n.getElementsByName || !n.getElementsByName(W).length
			...
			}, F = [], O = [], (w.qsa = ve.test(n.querySelectorAll)) && (i(function(e) {
			...
			})), (w.matchesSelector = ve.test(M = $.matches || $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && i(function(e) {
				w.disconnectedMatch = M.call(e, "div"), M.call(e, "[s!='']:x"), F.push("!=", ae)
			}), O = O.length && new RegExp(O.join("|")), F = F.length && new RegExp(F.join("|")), t = ve.test($.compareDocumentPosition), P = t || ve.test($.contains) ? function(e, t) {
				...
				return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === R && P(R, e) ? -1 : t === n || t.ownerDocument === R && P(R, t) ? 1 : D ? te.call(D, e) - te.call(D, t) : 0 : 4 & r ? -1 : 1)
			} : function(e, t) {
				if (e === t) return A = !0, 0;
				var r, i = 0,
					o = e.parentNode,
			...
			if ((e.ownerDocument || e) !== L && q(e), n = n.replace(fe, "='$1']"), w.matchesSelector && H && (!F || !F.test(n)) && (!O || !O.test(n))) try {
				var r = M.call(e, n);
				if (r || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
			} catch (i) {}
			return t(n, L, null, [e]).length > 0
		}, t.contains = function(e, t) {
			return (e.ownerDocument || e) !== L && q(e), P(e, t)
		}, t.attr = function(e, t) {
					...
					return 1 === r && 0 === i ? function(e) {
						...
						if (m) {
							...
							if (h = [s ? m.firstChild : m.lastChild], s && y) {
								for (l = m[W] || (m[W] = {}), c = l[e] || [], d = c[0] === B && c[1], p = c[0] === B && c[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();)
		...
		return f.prototype = T.filters = T.pseudos, T.setFilters = new f, k = t.tokenize = function(e, n) {
			...
			if (n = n || [], 1 === f.length) {
				...
				for (i = he.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !T.relative[a = s.type]);)
					if ((u = T.find[a]) && (r = u(s.matches[0].replace(we, Te), xe.test(o[0].type) && l(t.parentNode) || t))) {
	...
	Z.event = {
		...
		remove: function(e, t, n, r, i) {
			...
			if (m && (u = m.events)) {
				for (t = (t || "").match(de) || [""], c = t.length; c--;)
					if (a = De.exec(t[c]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
		...
		trigger: function(t, n, r, i) {
			...
			if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Se.test(d + Z.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), d = h.shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, t = t[Z.expando] ? t : new Z.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
				...
				for (o = 0;
					(s = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, l = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), l && l.apply(s, n), l = c && s[c], l && l.apply && Z.acceptData(s) && (t.result = l.apply(s, n), t.result === !1 && t.preventDefault());
	...
	Pe.optgroup = Pe.option, Pe.tbody = Pe.tfoot = Pe.colgroup = Pe.caption = Pe.thead, Pe.th = Pe.td, Z.extend({
		...
		buildFragment: function(e, t, n, r) {
			for (var i, o, s, a, u, c, l = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++)
				if (i = e[p], i || 0 === i)
					if ("object" === Z.type(i)) Z.merge(f, i.nodeType ? [i] : i);
					else if (Le.test(i)) {
				for (o = o || l.appendChild(t.createElement("div")), s = (qe.exec(i) || ["", ""])[1].toLowerCase(), a = Pe[s] || Pe._default, o.innerHTML = a[1] + i.replace(Ae, "<$1></$2>") + a[2], c = a[0]; c--;) o = o.lastChild;
			...
			for (l.textContent = "", p = 0; i = f[p++];)
				if ((!r || -1 === Z.inArray(i, r)) && (u = Z.contains(i.ownerDocument, i), o = v(l.appendChild(i), "script"), u && g(o), n))
					for (c = 0; i = o[c++];) Oe.test(i.type || "") && n.push(i);
			return l
		},
		...
		html: function(e) {
			return me(this, function(e) {
				...
				if ("string" == typeof e && !$e.test(e) && !Pe[(qe.exec(e) || ["", ""])[1].toLowerCase()]) {
					e = e.replace(Ae, "<$1></$2>");
					try {
		...
		domManip: function(e, t) {
			...
			var n, r, i, o, s, a, u = 0,
				...
				p = e[0],
				g = Z.isFunction(p);
			if (g || c > 1 && "string" == typeof p && !Q.checkClone && He.test(p)) return this.each(function(n) {
				var r = l.eq(n);
				g && (e[0] = p.call(this, n, r.html())), r.domManip(e, t)
			});
			if (c && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
				for (i = Z.map(v(n, "script"), d), o = i.length; c > u; u++) s = n, u !== f && (s = Z.clone(s, !0, !0), o && Z.merge(i, v(s, "script"))), t.call(this[u], s, u);
				if (o)
	...
	Z.param = function(e, t) {
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var e = this.type;
				return this.name && !Z(this).is(":disabled") && St.test(this.nodeName) && !jt.test(e) && (this.checked || !Ne.test(e))
			}).map(function(e, t) {
				var n = Z(this).val();
	...
	e.ActiveXObject && Z(e).on("unload", function() {
		...
		return Q.cors || Lt && !e.crossDomain ? {
			send: function(n, r) {
				...
				t = function(e) {
					return function() {
						t && (delete At[s], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(qt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
							text: o.responseText
	...
	Z.ajaxSetup({
		...
		return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Ht, "$1" + i) : t.jsonp !== !1 && (t.url += (lt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
	...
	return Z.noConflict = function(t) {
		return e.$ === Z && (e.$ = Pt), t && e.jQuery === Z && (e.jQuery = Mt), Z
	}, typeof t === ke && (e.jQuery = e.$ = Z), Z
}), define("app/carousel", ["jquery"], function(e) {
	function t(t) {
		this.$ct = t, this.$carousel = t.parent(), this.$item = t.children(), this.$width = t.children().width(), this.$count = t.children().length, this.$itemWidth = e(window).width(), this.init(), this.bind()
	}
	return t.prototype = {
		init: function() {
			this.$ct.find("li").width(this.$itemWidth), this.$ct.prepend(this.$item.eq(this.$count - 1).clone()), this.$ct.append(this.$item.eq(1).clone()), this.$ct.css({
				left: 0 - this.$itemWidth,
				width: this.$itemWidth * (this.$count + 2)
			})
		},
		bind: function() {
			this.cur = 0, this.isLocked = !1, this.setBgd(1), this.auto()
		},
		setBgd: function(e) {
			var t = this.$ct.find("li").eq(e).attr("data-img");
			this.$ct.find("li").eq(e).css({
		...
		palyNext: function(e) {
			var t = this,
				e = e || 1;
			this.isLocked || (this.isLocked = !0, this.$ct.animate({
				left: "-=" + this.$itemWidth * e
			}, function() {
				t.cur = (t.cur + e) % t.$count, 0 === t.cur && t.$ct.css({
					left: 0 - t.$itemWidth
				}), t.setBgd(t.cur + 1), t.isLocked = !1
			}))
		},
		auto: function() {
			var e = this;
...
}), define("app/gotop", ["jquery"], function(e) {
	function t() {
		this.creatNode(), this.bind()
	}
	return t.prototype = {
		creatNode: function() {
			e(".gotop").length || ($nodes = e('<a href="javascript:void()" class="gotop">TOP</a>'), e("body").append($nodes), this.target = e("body").find(".gotop"), this.target.css({
				display: "none"
			}))
		},
		bind: function() {
	...
	return t.prototype = {
		init: function() {
			var t = !1,
				n = this;
			e(window).on("scroll", function() {
				t && clearTimeout(clock), clock = setTimeout(function() {
					n.bind(), t = !0
				}, 200), t = !1
			})
		},
		bind: function() {
			...
			this.$nodes.each(function() {
				t.isVisibility(e(this)) && e(this).animate({
					opacity: 1
				}, 2e3)
			})
		},
		isVisibility: function(t) {
			var n = t.offset().top,
				r = e(window).height(),
...
}), define("app/waterfall", ["jquery"], function(e) {
	function t(e, t) {
		this.$ct = e, this.$itemWidth = t, this.$ctWidth = this.$ct.width(), this.length = Math.floor(this.$ctWidth / t), this.init()
	}
	return t.prototype = {
		init: function() {
			this.arr = [];
			for (var e = 0; e < this.length; e++) this.arr.push(0);
			this.bind()
		},
		bind: function() {
			var e = this,
		...
		loadMore: function(t) {
			...
			e.ajax({
				...
				jsonp: "jsoncallback",
				success: function(e) {
					"0" === e.status.code ? (console.log(e.data[0].short_name), n.ceatNode(e)) : alert("查询不到数据")
				},
				error: function() {
					console.log("请求失败")
				}
		...
		ceatNode: function(t) {
			for (var n = "", r = 0, i = t.data.length; i > r; r++) n += "<li class='item unset'>", n += " <a href='" + t.data[r].url + "'>", n += "      <img class='news-img' src='" + t.data[r].img_url + "' alt='img'>", n += "     <div class='new-words'>", n += "         <h3 class='news-head'>" + t.data[r].short_name + "</h3>", n += "         <p class='news-short'>" + t.data[r].short_intro + "</p>", n += "         <p class='createtime'>" + t.data[r].createtime + "</p>", n += "         <p class='source'>来源：" + t.data[r].source + "</p>", n += "     </div>", n += " </a>", n += "</li>";
			$nodes = e(n), this.$ct.append($nodes), this.$nodes = $nodes, this.setNode()
		},
		setNode: function() {
			var t = this,
				n = 0,
				r = t.$nodes.length;
			e(".unset").find("img").on("load", function() {
				n++, n === r && t.$ct.find(".unset").each(function() {
					for (var n = e(this).outerHeight(!0), r = 0, i = (t.arr[r], 0); i < t.arr.length; i++) t.arr[i] < t.arr[r] && (r = i);
					e(this).css({
						left: t.$itemWidth * r,
						top: t.arr[r]
					}), t.arr[r] += n, e(this).removeClass("unset");
					var o = Math.max.apply(null, t.arr);
					t.$ct.height(o)
				})
			})
		}
...
}), requirejs(["jquery", "app/carousel", "app/gotop", "app/exposure", "app/waterfall"], function(e, t, n, r, i) {
	new t(e(".img-ct")), new n;
	var o = e(".about-ct").children();
	new r(o), new i(e(".water-ct"), 280)
